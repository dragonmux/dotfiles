# Generated by Powerlevel10k configuration wizard on 2021-05-07 at 13:53 BST.
...
# sharp heads, blurred tails, 1 line, compact, fluent, transient_prompt,
...
() {
	...
	typeset -g POWERLEVEL9K_DIR_FOREGROUND='#628FBF'
	...
	typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#729FCF'
	...
	typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='#EF2929'
	# Context color in SSH without privileges.
	typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND='#AD7FA8'
	# Default context color (no privileges, no SSH).
	typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND='#8AE234'
